    ...
    public class HooopDataInitializer
    {
        ...
        public void SeedData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                artwork1.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/1.jpg"));
                artwork1.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/22.jpg"));
                artwork2.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/2.jpg"));
                artwork3.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/3.jpg"));
                artwork4.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/4.jpg"));
                artwork5.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/5.jpg"));
                artwork6.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/6.jpg"));
                artwork7.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/7.jpg"));
                artwork8.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/8.jpg"));
                artwork9.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/9.jpg"));
                artwork10.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/10.jpg"));
                artwork11.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/11.jpg"));
                artwork12.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/12.jpg"));
                artwork13.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/13.jpg"));
                artwork14.ImagePaths.Add(new ImagePath($"https://demostoragehogent.blob.core.windows.net/fakeartworks/14.jpg"));
